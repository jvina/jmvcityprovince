    ...
    public partial class myfirst : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Vancouver", 3000, "BC", null },
                    { 2, "Coquitlam", 2000, "BC", null },
                    { 3, "Richmond", 100, "BC", null },
                    { 4, "Toronto", 12334, "ON", null },
                    { 5, "Ajax", 100, "ON", null },
                    { 6, "Windsor", 100, "ON", null },
                    { 7, "Gatineau", 1344, "QC", null },
                    { 8, "Quebec City", 3256, "QC", null },
                    { 9, "Montreal", 45029, "QC", null }
                });
